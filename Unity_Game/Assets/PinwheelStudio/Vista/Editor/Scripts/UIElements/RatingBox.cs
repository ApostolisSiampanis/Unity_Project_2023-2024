...
{
    public class RatingBox : VisualElement
    {
        ...
        protected const string PREF_HIDE_COUNT = "vista-rating-hide-count";
        protected const string PREF_HIDE_DATE = "vista-rating-hide-date";

        public RatingBox() : base()
        {
            StyleSheet uss = Resources.Load<StyleSheet>("Vista/USS/Graph/RatingBox");
            this.styleSheets.Add(uss);

            m_imgui = new IMGUIContainer(OnIMGUI) { name = "imgui-container" };
            this.Add(m_imgui);
            AddToClassList("panel");
            AddToClassList("rating-box");
        ...
        private class StarsGUI
        {
            ...
            public static readonly GUIContent HOW_YOU_RATE = new GUIContent("       How is your experience with Vista?");
            ...
            public static Texture2D starTexture
            {
                get
                {
                    ...
                    {
                        s_starTexture = Resources.Load<Texture2D>("Vista/Textures/Star");
                    }
        ...
        private void DrawStageStars()
        {
            ...
            EditorGUILayout.LabelField(StarsGUI.HOW_YOU_RATE, EditorCommon.Styles.centeredLabel);
        ...
        private class FeedbackGUI
        {
            ...
            public static readonly string EMAIL_SUBJECT = "[VISTA] Rating and Feedback";
        ...
        private void DrawStageFeedback()
        {
            ...
            m_feedback = EditorGUILayout.TextArea(m_feedback, GUILayout.ExpandHeight(true));
        ...
        private class RateOnStoreGUI
        {
            ...
            public static readonly string REVIEW_LINK = $"{Links.STORE_PAGE}#review";
